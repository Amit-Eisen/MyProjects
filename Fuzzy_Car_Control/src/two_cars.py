...
class two_cars:
    ...
    def draw(self):
        ...
        ax.plot([0, self.road_Length], [self.road_Width / 2, self.road_Width / 2], 'k--')
        ax.plot([0, self.road_Length],
                [-self.road_Width / 2 - self.road_Margin, -self.road_Width / 2 - self.road_Margin], 'k-', linewidth=3)
        ax.plot([0, self.road_Length], [self.road_Width / 2 + self.road_Margin, self.road_Width / 2 + self.road_Margin],
                'k-', linewidth=3)
        ...
        ax.set_aspect('equal')
        ax.set_title(
            'Time: ' + str(round(self.t, 2)) + 'sec, distance between cars: ' + str(round(self.distance, 2)) + 'm')
        plt.pause(0.001)
